...
"docker.com|https://docker.com/" "nodesource.com|https://nodesource.com" "debian.org|http://debian.org" "openwrt.org|https://openwrt.org" \
"discord.com|https://discord.com" "x.com|https://x.com" "play.google.com|https://play.google.com" \
"cub.red|https://cub.red" >> "$OUT_DPI"; curl -fsSL "$RAW" | sed -n 's/.*"id":[[:space:]]*"\([^"]*\)".*"host":[[:space:]]*"\([^"]*\)".*/\1|\2/p' >> "$OUT_DPI" \
